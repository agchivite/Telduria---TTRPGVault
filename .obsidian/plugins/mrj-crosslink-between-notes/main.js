...
var AddLinkToCurrentNotePlugin = /** @class */ (function (_super) {
    ...
    function AddLinkToCurrentNotePlugin() {
        ...
        // }
        _this.addBacklink = function (files) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            lineToPaste = this.settings.template.replace(
                                "$link",
                                currentFileLink
                            );
                            succeed = [];
                            return [
                                4 /*yield*/,
                                Promise.all(
                                    filesToProduce.map(function (file) {
                                        return __awaiter(
                                            _this,
                                            void 0,
                                            void 0,
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        this.addSettingTab(
                            new CrosslinkSettingsTab(this.app, this)
                        );
                        this.addCommand({
    ...
    AddLinkToCurrentNotePlugin.prototype.getFilesFromLineOrSelection =
        function (view) {
            var _this = this;
            var cm = view.editor;
            ...
            var ar = [linksWiki, linksMD].filter(function (e) {
                return e.length;
            });
                    ...
                    (_c =
                        (_b =
                            ...
                            _a === void 0
                                ...
                                : _a[0]) === null || _b === void 0
                            ? void 0
                            : _b.replace(".md", "")) === null || _c === void 0
                        ? void 0
                        : _c.replace(/[()]/g, "")
                );
                return (
                    _this.getFilesByName(wikiName) ||
                    _this.getFilesByName(mdName)
                );
            });
        };
    AddLinkToCurrentNotePlugin.prototype.getFilesByName = function (name) {
        ...
        return files.filter(function (e) {
            return e.name === name || e.path === name || e.basename === name;
        })[0];
    };
...
var CrosslinkSettingsTab = /** @class */ (function (_super) {
    ...
    CrosslinkSettingsTab.prototype.display = function () {
        ...
        containerEl.createEl("h2", {
            text: 'Settings for "Add links to the current note" plugin',
        });
        new obsidian.Setting(containerEl)
            .setName("Template")
            .setDesc(
                "How the link will be pasted. `$link` will be replaced with link itself."
            )
