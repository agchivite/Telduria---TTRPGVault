...
**Classes**: [Bard](list-spells-classes-bard); [Cleric](list-spells-classes-cleric); [Druid](list-spells-classes-druid); [Paladin](list-spells-classes-paladin); [Wizard](list-spells-classes-wizard); [Warlock (Fiend Patron)](list-spells-classes-warlock-xphb-fiend-patron-xphb)
