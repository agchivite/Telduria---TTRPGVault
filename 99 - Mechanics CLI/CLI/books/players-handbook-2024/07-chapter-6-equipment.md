...
A Bullseye Lantern burns [Oil](3-Mechanics/CLI/items/oil-xphb.md) as fuel to cast [Bright Light](3-Mechanics/CLI/rules/variant-rules/bright-light-xphb.md) in a 60-foot [Cone [Area of Effect]](3-Mechanics/CLI/rules/variant-rules/cone-area-of-effect-xphb.md) and [Dim Light](3-Mechanics/CLI/rules/variant-rules/dim-light-xphb.md) for an additional 60 feet.
...
A Pole is 10 feet long. You can use it to touch something up to 10 feet away. If you must make a Strength ([Athletics](3-Mechanics/CLI/rules/skills.md#Athletics)) check as part of a [High Jump](3-Mechanics/CLI/rules/variant-rules/high-jump-xphb.md) or [Long Jump](3-Mechanics/CLI/rules/variant-rules/long-jump-xphb.md), you can use the Pole to vault, giving yourself [Advantage](3-Mechanics/CLI/rules/variant-rules/advantage-xphb.md) on the check.
