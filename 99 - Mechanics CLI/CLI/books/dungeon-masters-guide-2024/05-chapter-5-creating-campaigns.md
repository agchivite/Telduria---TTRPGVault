...
Sarana, the temple's **Archpriest** (Neutral Good), is a middle-aged, human woman wearing a sun-shaped headdress and yellow-and-gold robes. She is never seen in public without her [Staff of Healing](3-Mechanics/CLI/items/staff-of-healing-xdmg.md). Sarana has straw-colored hair, green eyes, and a forgiving nature.
...
- **Healing.** The temple sells [Spell Scrolls](3-Mechanics/CLI/items/spell-scroll-xdmg.md) of [Greater Restoration](3-Mechanics/CLI/spells/greater-restoration-xphb.md) for 3,200 GP apiece and [Spell Scrolls](3-Mechanics/CLI/items/spell-scroll-xdmg.md) of [Remove Curse](3-Mechanics/CLI/spells/remove-curse-xphb.md) for 300 GP apiece, and the priests have `1d3` copies of each scroll in stock on any given day. The priests also have [Cure Wounds](3-Mechanics/CLI/spells/cure-wounds-xphb.md) and [Lesser Restoration](3-Mechanics/CLI/spells/lesser-restoration-xphb.md) spells prepared, which they customarily cast for free.  
...
> - **Scholarly Expertise.** Characters who have proficiency in the [Arcana](3-Mechanics/CLI/rules/skills.md#Arcana), [History](3-Mechanics/CLI/rules/skills.md#History), or [Religion](3-Mechanics/CLI/rules/skills.md#Religion) skill can be fonts of useful information. When it would be helpful for a group to know something about the setting, ask such characters to make an Intelligence check using the relevant skill, then share plot-relevant details if their roll warrants it.  
