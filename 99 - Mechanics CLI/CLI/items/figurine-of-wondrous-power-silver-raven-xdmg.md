...
This silver statuette of a raven can become a [Raven](3-Mechanics/CLI/bestiary/beast/raven-xphb.md) for up to 12 hours. Once it has been used, it can't be used again until 2 days have passed. While in raven form, the figurine grants you the ability to cast [Animal Messenger](3-Mechanics/CLI/spells/animal-messenger-xphb.md) on it.
