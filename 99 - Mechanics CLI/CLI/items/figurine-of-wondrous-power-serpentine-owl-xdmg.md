...
This serpentine statuette of an owl can become a [Giant Owl](3-Mechanics/CLI/bestiary/beast/giant-owl-xmm.md) for up to 8 hours. The owl can communicate telepathically with you at any range if you and it are on the same plane of existence. Once it has been used, it can't be used again until 2 days have passed.
