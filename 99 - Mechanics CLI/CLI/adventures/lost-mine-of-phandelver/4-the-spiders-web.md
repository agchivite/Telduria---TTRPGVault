...
| 11 | [Wolves](3-Mechanics/CLI/bestiary/beast/wolf-xphb.md) (`1d4 + 2`) |
...
| 9-10 | [Wolves](3-Mechanics/CLI/bestiary/beast/wolf-xphb.md) (`1d4 + 2`) |
...
Twelve [zombies](3-Mechanics/CLI/bestiary/undead/zombie-xphb.md) lurk inside the crumbled shell of the old watchtower and can't be seen from outside. However, any character with a passive Wisdom (Perception) score of 10 or higher smells a deathly odor wafting from the tower's direction. When characters approach the tower or the tent, the zombies shamble out of the tower.
...
Two [twig blights](3-Mechanics/CLI/bestiary/plant/twig-blight.md) hide among the weeds that flank the cottage's open doorway. Make a Dexterity (Stealth) check for the blights, and compare the result to the passive Wisdom (Perception) scores of the characters to determine if the blights are spotted.
...
The overgrowth conceals a deadly threat-six [twig blights](3-Mechanics/CLI/bestiary/plant/twig-blight.md) lurking among the ordinary foliage. Spotting them requires a successful Wisdom (Perception) check challenged by the blights' Dexterity (Stealth) check.
...
Two [giant spiders](3-Mechanics/CLI/bestiary/beast/giant-spider-xphb.md) hide on the inner walls in this ruined building, so they are not visible from outside. Trailing lines from the webs in the lane allow the spiders to sense when prey is moving through the webs, at which point they nimbly scuttle over the wall and attack. The alert spiders surprise any character whose passive Wisdom (Perception) score is less than 17.
...
A young green dragon named [Venomfang](3-Mechanics/CLI/bestiary/npc/venomfang-lmop.md) has recently claimed the tower, having passed over Thundertree while searching Neverwinter Wood for a suitable lair. The giant spider corpses are the former residents of the tower, killed by the dragon after it tore its way through the roof. Since then, [Venomfang](3-Mechanics/CLI/bestiary/npc/venomfang-lmop.md) has been laying low.
...
An old wooden chest broken open on the tower floor holds the last of the dead wizard's treasure: 800 sp, 150 gp, four silver goblets set with moonstones (60 gp each), a scroll of misty step, and a scroll of lightning bolt. [Venomfang](3-Mechanics/CLI/bestiary/npc/venomfang-lmop.md) spends much of his time greedily admiring the loot.
...
Six [twig blights](3-Mechanics/CLI/bestiary/plant/twig-blight.md) lurk in the thicket south of this ruin. Allow each character to attempt a Wisdom (Perception) check contested by the blights' Dexterity (Stealth) check to avoid being surprised by them.
...
The marauders in the cave include Brughor Axe-Biter (an [orc](3-Mechanics/CLI/bestiary/humanoid/orc.md) with 30 hit points), six ordinary [orcs](3-Mechanics/CLI/bestiary/humanoid/orc.md), and a filthy [ogre](3-Mechanics/CLI/bestiary/giant/ogre-xmm.md) named Gog. Gog fights until slain, while the orcs fight until Brughor is killed, at which point any remaining orcs flee.
...
Near the southwest corner of the room is [Gundren Rockseeker](3-Mechanics/CLI/bestiary/npc/gundren-rockseeker-lmop.md), a dwarf [commoner](3-Mechanics/CLI/bestiary/humanoid/commoner.md). He is unconscious but stable at 0 hit points.
...
You can add a complication in the form of a hobgoblin war band returning home, just as the characters are preparing to leave. This war band consists of three [hobgoblins](3-Mechanics/CLI/bestiary/humanoid/hobgoblin.md) led by Targor Bloodsword, a [hobgoblin](3-Mechanics/CLI/bestiary/humanoid/hobgoblin.md) with 20 hit points. Targor also has two [wolves](3-Mechanics/CLI/bestiary/beast/wolf-xphb.md) as pets.
