...
Three [bugbears](3-Mechanics/CLI/bestiary/humanoid/bugbear.md) and one [goblin](3-Mechanics/CLI/bestiary/humanoid/goblin.md) are present. The goblin, Droop, falls unconscious at the sight of the party, but another creature can use an action to wake him. Otherwise, Droop remains unconscious for `1d10` minutes.
