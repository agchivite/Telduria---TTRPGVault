...
- "desc": "Melee Weapon Attack: +5 to hit, reach 10 ft., one creature. Hit:\
    ...
    \ grappled (escape DC 13) and pulled 5 feet toward the water weird. Until this\
    \ grapple ends, the target is restrained, the water weird tries to drown it, and\
    \ the water weird can't constrict another target."
  "name": "Constrict"
"source":
- "XMM"
```
