...
- "desc": "Ranged Spell Attack: +2 to hit, range 60 ft., one target. Hit: 7\
  ...
  "name": "Radiant Pellet"
"bonus_actions":
- "desc": "The aartuk magically ends the charmed and frightened conditions on itself\
...
- "desc": "The aartuk tries to use its gooey tongue to snare one Medium or smaller\
    ...
    \ DC 11) and pulled up to 25 feet toward the aartuk. The tongue can grapple one\
    \ creature at a time."
