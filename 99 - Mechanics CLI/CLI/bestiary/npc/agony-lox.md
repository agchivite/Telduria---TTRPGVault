...
- "desc": "Each non-undead creature within 60 feet of Agony that can see it must succeed\
    \ on a DC 13 Wisdom saving throw or be frightened for 1 minute. If the save fails\
    \ by 5 or more, the target also ages 1d4 × 10 years. A frightened target can\
...
- "desc": "One humanoid that Agony can see within 5 feet of it must succeed on a DC\
    ...
    \ the target is incapacitated and loses control of its body. Agony now controls\
    \ the body but doesn't deprive the target of awareness. Agony can't be targeted\
    ...
    \nThe possession lasts until the body drops to 0 hit points, Agony ends it as\
    \ a bonus action, or Agony is turned or forced out by an effect like the dispel\
    \ evil and good spell. When the possession ends, Agony reappears in an unoccupied\
