...
- "desc": "The mouther babbles incoherently while it can see any creature and isn't\
    ...
    \ and rolls a d8 to determine what it does during its turn. On a 1 to 4, the\
    \ creature does nothing. On a 5 or 6, the creature takes no action or bonus action\
    \ and uses all its movement to move in a randomly determined direction. On a 7\
    \ or 8, the creature makes a melee attack against a randomly determined creature\
...
- "desc": "Melee Weapon Attack: +2 to hit, reach 5 ft., one creature. Hit: 17\
    ...
    \ on a DC 10 Strength saving throw or be knocked prone. If the target is killed\
    \ by this damage, it is absorbed into the mouther."
  "name": "Bites"
