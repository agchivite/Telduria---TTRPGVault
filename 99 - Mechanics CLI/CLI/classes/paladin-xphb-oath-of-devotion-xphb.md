...
Your magical smite now radiates protective energy. Whenever you cast [Divine Smite](3-Mechanics/CLI/spells/divine-smite-xphb.md), you and your allies have [Cover](3-Mechanics/CLI/rules/variant-rules/cover-xphb.md) while in your Aura of Protection. The aura has this benefit until the start of your next turn.
...
Whenever an enemy starts its turn in the aura, that creature takes Radiant damage equal to your Charisma modifier plus your [Proficiency](3-Mechanics/CLI/rules/variant-rules/proficiency-xphb.md).
