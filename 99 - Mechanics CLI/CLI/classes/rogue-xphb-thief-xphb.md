...
If you have the [Hide](3-Mechanics/CLI/rules/actions.md#Hide) action's [Invisible](3-Mechanics/CLI/rules/conditions.md#Invisible) condition, this attack doesn't end that condition on you if you end the turn behind [Cover](3-Mechanics/CLI/rules/variant-rules/cover-xphb.md) or [Cover](3-Mechanics/CLI/rules/variant-rules/cover-xphb.md).
