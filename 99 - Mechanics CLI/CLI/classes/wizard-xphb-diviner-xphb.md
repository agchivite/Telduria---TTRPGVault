...
You can increase your powers of perception. As a [Bonus Action](3-Mechanics/CLI/rules/variant-rules/bonus-action-xphb.md), choose one of the following benefits, which lasts until you start a [Short Rest](3-Mechanics/CLI/rules/variant-rules/short-rest-xphb.md) or [Long Rest](3-Mechanics/CLI/rules/variant-rules/long-rest-xphb.md). You can't use this feature again until you finish a [Short Rest](3-Mechanics/CLI/rules/variant-rules/short-rest-xphb.md) or [Long Rest](3-Mechanics/CLI/rules/variant-rules/long-rest-xphb.md).
